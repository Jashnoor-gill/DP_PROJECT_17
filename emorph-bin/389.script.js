"use strict";
(self.webpackChunkpwb_website_base = self.webpackChunkpwb_website_base || []).push([[389], {
    2546: (e, t, n) => {
        n.d(t, {
            D: () => r,
            x: () => i
    ...
    3389: (e, t, n) => {
        ...
        const v = (e, t, n="/") => y(void 0, void 0, void 0, (function*() {
            const o = `${(0,
            h.gZ)(n)}${e}`
              , i = yield(0,
            g.x)(o);
            ...
            if (!s.includes(t))
                throw new Error(`Unexpected content type "${s}" for file "${o}".`);
            return r
        }
        ))
          , w = (e, t) => y(void 0, void 0, void 0, (function*() {
            const n = t => {
                var n, o;
                const i = null === (n = e.devices[t]) || void 0 === n ? void 0 : n.canvases;
                if (i)
                    return null === (o = Object.values(i)[0]) || void 0 === o ? void 0 : o.sceneId
            }
            ;
            let o = n(t);
            for (; t !== p.SN.Desktop && void 0 === o; )
                t === p.SN.Mobile ? t = p.SN.Tablet : t === p.SN.Tablet && (t = p.SN.Desktop),
                o = n(t);
            if (!o || "None" === o)
                return null;
            const i = yield v(`${m.lx.SceneState}/${o}.json`, "application/json");
            return yield i.json()
        }
        ))
          , b = e => y(void 0, void 0, void 0, (function*() {
            const t = yield v(`${m.lx.UIState}`, "application/json", e);
            return yield t.json()
        }
        ))
          , _ = e => y(void 0, void 0, void 0, (function*() {
            try {
          ...
          , E = e => y(void 0, void 0, void 0, (function*() {
            const t = yield v(m.lx.Styles, "text/css", e);
            return yield t.text()
        }
        ))
          , P = () => y(void 0, void 0, void 0, (function*() {
            const e = yield v(m.lx.ErrorPage, "text/html");
            return yield e.text()
        }
        ))
          , O = () => y(void 0, void 0, void 0, (function*() {
        ...
        const {startIgnoringDependencies: H, stopIgnoringDependencies: W, reportResolutionEnd: $, reportResolutionStart: z, pushCollector: G, popCollector: q} = function() {
            const e = "__dataverse_discoveryMechanism_sharedStack"
              , t = "undefined" != typeof window ? window : void 0 !== n.g ? n.g : {};
            if (t) {
                const n = t[e];
                if (n && "object" == typeof n && "Dataverse_discoveryMechanism" === n.type)
                    return n;
                {
                    const n = V();
                    return t[e] = n,
        ...
        class J {
            ...
            _recalculate() {
                ...
                try {
                    ...
                    te.pop() !== this._scope && console.warn("The Prism hook stack has slipped. This is a bug.")
                }
                q(n);
                for (const e of this._dependencies)
                ...
                H();
                for (const e of t)
                    this._cacheOfDendencyValues.set(e, e.getValue());
                return W(),
                e
            }
            forceStale() {
            ...
            _addDependency(e) {
                this._dependencies.has(e) || (this._dependencies.add(e),
                e._addDependent(this._reactToDependencyGoingStale))
            }
            _removeDependency(e) {
                this._dependencies.has(e) && (this._dependencies.delete(e),
                e._removeDependent(this._reactToDependencyGoingStale))
            }
        }
        const Y = {};
        class K {
            ...
            _addDependent(e) {
                ...
                this._state.handle.addDependent(e)
            }
            _goHot() {
            ...
            getValue() {
                ...
                return t = e.hot ? e.handle.getValue() : function(e) {
                    ...
                    try {
                        ...
                        te.pop() !== t && console.warn("The Prism hook stack has slipped. This is a bug.")
                    }
                    return n
                }(this._fn),
                $(this),
        ...
        class Z {
            ...
            effect(e, t, n) {
                ...
                this.effects.set(e, o)),
                ne(o.deps, n) && (o.cleanup(),
                H(),
            ...
            memo(e, t, n) {
                ...
                this.memos.set(e, o)),
                ne(o.deps, n) && (H(),
                o.cachedValue = ee(t, void 0).value,
                W(),
                o.deps = n),
                o.cachedValue
            }
            state(e, t) {
                const {value: n, setValue: o} = this.memo("state/" + e, ( () => {
                    const e = {
                        current: t
                    };
                    return {
            ...
            sub(e) {
                return this.subs[e] || (this.subs[e] = new Z(this._hotHandle)),
                this.subs[e]
            }
            cleanupEffects() {
        ...
        const ce = e => Array.isArray(e) ? ae.Array : (0,
        x.A)(e) ? ae.Dict : ae.Other
          , le = (e, t, n=ce(e)) => n === ae.Dict && "string" == typeof t || n === ae.Array && ue(t) ? e[t] : void 0
          , ue = e => {
        ...
        class de {
            ...
            getOrCreateChild(e) {
                ...
                return t || (t = t = new de(this,this._path.concat([e])),
                this.children.set(e, t)),
                t
            }
            _checkForGC() {
                this.identityChangeListeners.size > 0 || this.children.size > 0 || this._parent && this._parent.removeChild((0,
                R.A)(this._path))
            }
        }
        class fe {
            ...
            set(e) {
                ...
                this._currentState = e,
                this._checkUpdates(this._rootScope, t, e)
            }
            get() {
            ...
            _checkUpdates(e, t, n) {
                if (t === n)
                    return;
                for (const t of e.identityChangeListeners)
                    t(n);
                if (0 === e.children.size)
                    return;
                const o = ce(t)
                  , i = ce(n);
                if (o !== ae.Other || o !== i)
        ...
        class ye {
            ...
            _goActive() {
                ...
                null === (t = null === (e = this._conf) || void 0 === e ? void 0 : e.onActive) || void 0 === t || t.call(e))
            }
            _goDormant() {
                var e, t;
                this._dormant || (this._dormant = !0,
                this._numberOfDormantTicks = 0,
                null === (t = null === (e = this._conf) || void 0 === e ? void 0 : e.onDormant) || void 0 === t || t.call(e))
            }
            tick(e=performance.now()) {
                if (this.__ticks++,
                !this._dormant && 0 === this._scheduledForNextTick.size && 0 === this._scheduledForThisOrNextTick.size && (this._numberOfDormantTicks++,
                this._numberOfDormantTicks >= 180))
                    this._goDormant();
                else {
                    this._ticking = !0,
            ...
            _tick(e) {
                const t = this.time;
                if (e > 10 && console.warn("_tick() recursing for 10 times"),
                e > 100)
        ...
        function xe(e) {
            ...
            const t = "compound" === e.type ? function(e) {
                ...
                for (const [n,o] of Object.entries(e.cases))
                    t[n] = xe(o);
                return t
            }(e) : e.default;
            return Me.set(e, t),
        ...
        function De(e, t, n) {
            return se(( () => {
                const o = ge(t)
                  , i = se.memo("driver", ( () => o ? "BasicKeyframedTrack" === o.type ? function(e, t, n) {
                    return se(( () => {
                        const e = se.ref("state", {
                            started: !1
                        });
                        let o = e.current;
                        const i = n.getValue();
                        return (!o.started || i < o.validFrom || o.validTo <= i) && (e.current = o = function(e, t, n) {
                            const o = ke.getSortedKeyframesCached(n.keyframes)
                              , i = t.getValue();
                            if (0 === o.length)
                                return {
                                    started: !0,
                            ...
                            for (; ; ) {
                                ...
                                if (i < e.position)
                                    return 0 === r ? Ne.beforeFirstKeyframe(e) : Ne.error;
                                if (e.position === i)
                                    return n ? Ne.lastKeyframe(e) : Ne.between(e, o[r + 1], t);
                                if (r === o.length - 1)
                ...
                }(0, o, n) : (e.logger.error("Track type not yet supported."),
                se(( () => {}
                ))) : se(( () => {}
                ))), [o]);
                return i.getValue()
        ...
        !function(e) {
            e.getSortedKeyframes = e => {
                ...
                return t.sort(( (e, t) => e.position - t.position)),
                (0,
                Ce.A)(t)
            }
            ,
        ...
        const Ne = {
            ...
            between(e, t, n) {
                ...
                if (!e.type || "bezier" === e.type) {
                    const i = new (Ae())(e.handles[2],e.handles[3],t.handles[0],t.handles[1])
                      , r = se(( () => {
        ...
        function Le(e, t, n) {
            ...
            for (const o of Object.keys(t)) {
                const r = t[o]
                  , s = e[o];
                i[o] = "object" == typeof r && "object" == typeof s ? Le(s, r, n) : void 0 === r ? s : r
            }
            return n.set(e, {
                override: t,
                merged: i
        ...
        class Ue {
            ...
            get value() {
                ...
                return this._keepHotUntapDebounce && this._keepHotUntapDebounce(),
                e.getValue()
            }
            set initialValue(e) {
        ...
        class $e {
            ...
            constructor(e, t, n) {
                ...
                this._cache = new Oe,
                this._logger = e._logger.named("SheetObject", t.address.objectKey),
            ...
            getValues() {
                return this._cache.get("getValues()", ( () => se(( () => {
                    const e = Le(ge(this.template.getDefaultValues()), ge(this._initialValue.pointer), se.memo("withInitialCache", ( () => new WeakMap), []));
                    let t, n = Le(e, ge(this.template.getStaticValues()), se.memo("withStatics", ( () => new WeakMap), []));
                    {
            ...
            getSequencedValues() {
                return se(( () => {
                    const e = se.memo("tracksToProcess", ( () => this.template.getArrayOfValidSequenceTracks()), [])
                      , t = ge(e)
                      , n = new fe({})
                      , o = ge(this.template.configPointer);
                    return se.effect("processTracks", ( () => {
                        const e = [];
                        for (const {trackId: i, pathToProp: r} of t) {
                            const t = this._trackIdToPrism(i)
                              ...
                              , l = () => {
                                const e = t.getValue();
                                if (!e)
                                    return n.setByPointer((e => Be(e, r)), void 0);
                                const o = a(e.left)
                                ...
                                return n.setByPointer((e => Be(e, r)), c(i, u, e.progression))
                            }
                              , u = t.onStale(l);
                            l(),
                            e.push(u)
            ...
            get propsP() {
                return this._cache.get("propsP", ( () => L({
                    root: this,
                    path: []
                })))
            }
        ...
        function Ke(e) {
            return Object.freeze({
                audience: Ze(e, qe.INTERNAL) ? "internal" : Ze(e, qe.DEV) ? "dev" : "public",
                category: Ze(e, Ge.TROUBLESHOOTING) ? "troubleshooting" : Ze(e, Ge.TODO) ? "todo" : "general",
                level: Ze(e, Xe.ERROR) ? Xe.ERROR : Ze(e, Xe.WARN) ? Xe.WARN : Ze(e, Xe.DEBUG) ? Xe.DEBUG : Xe.TRACE
            })
        }
        function Ze(e, t) {
            return (e & t) === t
        ...
        function Qe(e, t) {
            return ((t & qe.PUBLIC) === qe.PUBLIC || ((t & qe.DEV) === qe.DEV ? e.dev : (t & qe.INTERNAL) === qe.INTERNAL && e.internal)) && e.min <= t
        }
        const et = {
            ...
            style: {
                ...
                collapsed(e) {
                    ...
                    return this.cssMemo.has(t) || this.cssMemo.set(t, this.css(e)),
                    t
                },
                css(e) {
                    var t, n, o, i;
                    ...
                    return (null === (o = this.bold) || void 0 === o ? void 0 : o.test(e)) && (s += ";font-weight:600"),
                    (null === (i = this.italic) || void 0 === i ? void 0 : i.test(e)) && (s += ";font-style:italic"),
        ...
        function tt(e=console, t={}) {
            const n = Object.assign(Object.assign({}, et), {
              ...
              , i = ot.bind(n);
            function r() {
                return n.loggingConsoleStyle && n.loggerConsoleStyle ? o.styled : o.noStyle
            }
            return n.create = r(),
            {
                configureLogger(e) {
                    var t;
                    "console" === e ? (n.loggerConsoleStyle = et.loggerConsoleStyle,
                    n.create = r()) : "console" === e.type ? (n.loggerConsoleStyle = null !== (t = e.style) && void 0 !== t ? t : et.loggerConsoleStyle,
                    n.create = r()) : "keyed" === e.type ? (n.creatExt = t => e.keyed(t.names),
                    n.create = i) : "named" === e.type && (n.creatExt = nt.bind(null, e.named),
                    n.create = i)
                },
                configureLogging(e) {
                    var t, o, i, s, a;
                    n.includes.dev = null !== (t = e.dev) && void 0 !== t ? t : et.includes.dev,
                    n.includes.internal = null !== (o = e.internal) && void 0 !== o ? o : et.includes.internal,
                    n.includes.min = null !== (i = e.min) && void 0 !== i ? i : et.includes.min,
                    n.include = null !== (s = e.include) && void 0 !== s ? s : et.include,
                    n.loggingConsoleStyle = null !== (a = e.consoleStyle) && void 0 !== a ? a : et.loggingConsoleStyle,
                    n.create = r()
                },
                getLogger: () => n.create({
                    names: []
        ...
        function it(e, t) {
            ...
            for (let e = 0; e < t.names.length; e++) {
                ...
                if (i += ` %c${n}`,
                o.push(this.style.css(n)),
                null != r) {
                    const e = `%c#${r}`;
                    i += e,
                    o.push(this.style.css(e))
                }
            }
            const r = this.filtered
              , s = this.named.bind(this, t)
              , a = [i, ...o];
            return st(r, t, n, e, a, function(e) {
                const t = e.slice(0);
        ...
        const ct = at.getLogger().named("Theatre.js (default logger)").utilFor.dev()
          , lt = new WeakMap;
        function ut(e, t, n) {
            for (const [o,i] of Object.entries(t.props))
                if (!Ve(i)) {
                    const t = [...e, o];
                    n.set(JSON.stringify(t), n.size),
                    dt(t, i, n)
                }
            for (const [o,i] of Object.entries(t.props))
                if (Ve(i)) {
        ...
        class ht {
            ...
            getDefaultValues() {
                return this._cache.get("getDefaultValues()", ( () => se(( () => function(e) {
                    return xe(e)
                }(ge(this.configPointer))))))
            }
            getStaticValues() {
                return this._cache.get("getStaticValues", ( () => se(( () => {
                    var e;
                    const t = null !== (e = ge(this.pointerToStaticOverrides)) && void 0 !== e ? e : {};
                    return ge(this.configPointer).deserializeAndSanitize(t) || {}
                }
                ))))
            }
            getArrayOfValidSequenceTracks() {
                return this._cache.get("getArrayOfValidSequenceTracks", ( () => se(( () => {
                    const e = this.project.pointers.historic.sheetsById[this.address.sheetId]
                      , t = ge(e.sequence.tracksByObject[this.address.objectKey].trackIdByPropPath);
                    if (!t)
                        return Ee;
                    const n = [];
                    if (!t)
                    ...
                    return n.sort(( (e, t) => {
                        const n = e.pathToProp
                          , o = t.pathToProp;
                        return r.get(JSON.stringify(n)) > r.get(JSON.stringify(o)) ? 1 : -1
                    }
                    )),
                    0 === n.length ? Ee : n
                }
            ...
            getMapOfValidSequenceTracks_forStudio() {
                return this._cache.get("getMapOfValidSequenceTracks_forStudio", ( () => se(( () => {
                    const e = ge(this.getArrayOfValidSequenceTracks())
                      , t = {};
                    for (const {pathToProp: n, trackId: o} of e)
                        (0,
                        Te.A)(t, n, o);
                    return t
                }
            ...
            getStaticButNotSequencedOverrides() {
                return this._cache.get("getStaticButNotSequencedOverrides", ( () => se(( () => {
        ...
        function mt(e) {
            try {
                ...
                return void ct.warn(`property ${JSON.stringify(e)} cannot be parsed. Skipping.`)
            }
        }
        ...
        class St {
            ...
            play(e, t, n, o, i) {
                ...
                const r = t[1] - t[0];
                {
                    ...
                    e < t[0] || e > t[1] ? "normal" === o || "alternate" === o ? this._updatePositionInState(t[0]) : "reverse" !== o && "alternateReverse" !== o || this._updatePositionInState(t[1]) : "normal" === o || "alternate" === o ? e === t[1] && this._updatePositionInState(t[0]) : e === t[0] && this._updatePositionInState(t[1])
                }
                const s = bt()
                  , a = i.time
                  , c = r * e;
                let l = this.getCurrentPosition() - t[0];
                "reverse" !== o && "alternateReverse" !== o || (l = t[1] - this.getCurrentPosition());
                const u = i => {
                    ...
                    if (f !== c) {
                        ...
                        this._updatePositionInState(n + t[0]),
                        d()
                    } else {
                        if ("normal" === o)
                            ...
                            const n = (e - 1) % 2 == 0;
                            "alternate" === o ? n ? this._updatePositionInState(t[1]) : this._updatePositionInState(t[0]) : n ? this._updatePositionInState(t[0]) : this._updatePositionInState(t[1])
                        }
                        this.playing = !1,
                        s.resolve(!0)
                    }
            ...
            playDynamicRange(e, t) {
                ...
                ;
                this._stopPlayCallback = () => {
                    t.offThisOrNextTick(r),
                    t.offNextTick(r),
                    n.resolve(!1)
                }
                ;
                const s = () => t.onNextTick(r);
                return t.onThisOrNextTick(r),
                n.promise
            }
        }
        ...
        "undefined" != typeof window && (window.addEventListener("error", (e => {
            Ot.error("An error occurred", `<pre>${e.message}</pre>\n\nSee **console** for details.`)
        }
        )),
        window.addEventListener("unhandledrejection", (e => {
            Ot.error("An error occurred", `<pre>${e.reason}</pre>\n\nSee **console** for details.`)
        }
        )));
        class Tt {
            constructor(e, t, n) {
            ...
            playDynamicRange(e, t) {
                ...
                const i = () => {
                    null == o || o(),
                    o = this._loopInRange(e.getValue(), t).stop
                }
                  , r = e.onStale(i);
                return i(),
                this._stopPlayCallback = () => {
            ...
            _loopInRange(e, t) {
                ...
                const o = e[1] - e[0];
                (n < e[0] || n > e[1] || n === e[1]) && this._updatePositionInState(e[0]),
                ...
                const a = t => {
                    ...
                    this._updatePositionInState(n + e[0]),
                    c()
                }
                  , c = () => t.onNextTick(a);
            ...
            play(e, t, n, o, i) {
                ...
                const s = t[1] - t[0];
                if ("normal" !== o)
                    throw new vt(`Audio-controlled sequences can only be played in the "normal" direction. '${o}' given.`);
                (r < t[0] || r > t[1] || r === t[1]) && this._updatePositionInState(t[0]),
                r = this.getCurrentPosition();
                const a = bt()
                ...
                e > 1e3 && (Ot.warning("Can't play sequences with audio more than 1000 times", `The sequence will still play, but only 1000 times. The \`iterationCount: ${e}\` provided to \`sequence.play()\`\nis too high for a sequence with audio.\n\nTo fix this, either set \`iterationCount\` to a lower value, or remove the audio from the sequence.`, [{
                ...
                const f = e => {
                    ...
                    if (i !== d) {
                        let e = i / s % 1 * s;
                        this._updatePositionInState(e + t[0]),
                        h()
                    } else
                        this._updatePositionInState(t[1]),
                        this._playing = !1,
            ...
            const t = function(e) {
                ...
                const n = new ye({
                  ...
                  , o = {
                    ...
                    ,
                    id: xt++,
                    name: null !== (t = null == e ? void 0 : e.name) && void 0 !== t ? t : `CustomRafDriver-${xt}`,
        ...
        class kt {
            ...
            play(e) {
                ...
                if (t._project.isReady()) {
                    const n = (null == e ? void 0 : e.rafDriver) ? _e(e.rafDriver).ticker : Ct();
            ...
            attachAudio(e) {
                return It(this, void 0, void 0, (function*() {
                    const {audioContext: t, destinationNode: n, decodedBuffer: o, gainNode: i} = yield function(e) {
                        return It(this, void 0, void 0, (function*() {
                            function t() {
                                if (e.audioContext)
                      ...
                      , r = new Tt(o,t,i);
                    return _e(this).replacePlaybackController(r),
                    {
                        audioContext: t,
                        destinationNode: n,
                        decodedBuffer: o,
        ...
        class Lt {
            constructor(e, t, n, o, i) {
                ...
                ,
                this._logger = e._logger.named("Sheet", t.address.sheetId).named("Instance", t.address.sheetInstanceId),
                this.address = Object.assign(Object.assign({}, this._sheet.address), {
                    sequenceName: "default"
                }),
                this.publicApi = new kt(this),
                this._playbackControllerBox = new fe(null != i ? i : new St),
                this._prismOfStatePointer = se(( () => this._playbackControllerBox.prism.getValue().statePointer)),
                this._positionD = se(( () => {
            ...
            pointerToPrism(e) {
                ...
                const [n] = t;
                return "length" === n ? this._lengthD : "position" === n ? this._positionD : se("playing" === n ? () => ge(this._prismOfStatePointer.getValue().playing) : () => {}
                )
            }
            getKeyframesOfSimpleProp(e) {
                const {path: t, root: n} = j(e);
                if (!Dt(n))
                    throw new vt("Argument prop must be a pointer to a SheetObject property");
                const o = ge(this._project.pointers.historic.sheetsById[this._sheet.address.sheetId].sequence.tracksByObject[n.address.objectKey]);
                if (!o)
                    return [];
            ...
            play(e, t) {
                return Nt(this, void 0, void 0, (function*() {
                    ...
                    const i = e && "number" == typeof e.iterationCount ? e.iterationCount : 1;
        ...
        class Bt {
            ...
            formatForPlayhead(e) {
                ...
                if (t >= Vt) {
                    ...
                    n += (0,
                    wt.A)(e.toString(), 2, "0") + "h",
                    t %= Vt
                }
                if (t >= Ut) {
                    const e = Math.floor(t / Ut);
                    n += (0,
                    wt.A)(e.toString(), 2, "0") + "m",
                    t %= Ut
                } else
                    n.length > 0 && (n += "00m");
                if (t >= Ft) {
        ...
        function zt(e) {
            ...
            return function(e) {
                return Object.fromEntries(Object.entries(e).map(( ([e,t]) => [e, (0,
                Ht.A)(t, 0, 1)])))
            }({
                r: t(e.r),
                g: t(e.g),
        ...
        function qt(e) {
            let t = .4122214708 * e.r + .5363325363 * e.g + .0514459929 * e.b
              ...
              , o = .0883024619 * e.r + .2817188376 * e.g + .6299787005 * e.b
              , i = Math.cbrt(t)
              , r = Math.cbrt(n)
              , s = Math.cbrt(o);
            return {
                L: .2104542553 * i + .793617785 * r - .0040720468 * s,
                a: 1.9779984951 * i - 2.428592205 * r + .4505937099 * s,
                b: .0259040371 * i + .7827717662 * r - .808675766 * s,
                alpha: e.a
            }
        }
        var Xt = n(2854);
        ...
        const Yt = e => "string" == typeof e ? `string("${Jt(e, 10)}")` : "number" == typeof e ? `number(${Jt(String(e), 10)})` : null === e ? "null" : void 0 === e ? "undefined" : "boolean" == typeof e ? String(e) : Array.isArray(e) ? "array" : "object" == typeof e ? "object" : "unknown"
        ...
        : on
          ...
          , an = e => {
            ...
            for (const n of ["r", "g", "b", "a"])
                Object.prototype.hasOwnProperty.call(e, n) && "number" == typeof e[n] || (t = !1);
            if (!t)
                return;
            const n = {};
            for (const t of ["r", "g", "b", "a"])
            ...
            const o = qt(Gt(e))
              ...
              , r = zt(function(e) {
                let t = e.L + .3963377774 * e.a + .2158037573 * e.b
                  ...
                  , o = e.L - .0894841775 * e.a - 1.291485548 * e.b
                  , i = t * t * t
                  , r = n * n * n
                  , s = o * o * o;
                return {
                    r: 4.0767416621 * i - 3.3077115913 * r + .2309699292 * s,
                    g: -1.2684380046 * i + 2.6097574011 * r - .3413193965 * s,
                    b: -.0041960863 * i - .7034186147 * r + 1.707614701 * s,
                    a: e.alpha
                }
            }({
                L: (1 - n) * o.L + n * i.L,
        ...
        const hn = ({config: e, deltaX: t, deltaFraction: n, magnitude: o}) => {
            var i;
            const {range: r} = e;
            return e.nudgeMultiplier || !r || r.includes(1 / 0) || r.includes(-1 / 0) ? t * o * (null !== (i = e.nudgeMultiplier) && void 0 !== i ? i : 1) : n * (r[1] - r[0]) * o
        }
        ;
        function mn(e, t, n) {
            const o = e.replace(/^[\s\/]*/, "").replace(/[\s\/]*$/, "").replace(/\s*\/\s*/g, " / ");
            return o
        }
        new WeakMap;
        class gn {
            ...
            object(e, t, n) {
                ...
                if (r)
                    return s && r.template._temp_setActions(s),
                    r.publicApi;
                {
                    const e = en(t);
        ...
        class vn {
            ...
            createObject(e, t, n, o={}) {
                const i = this.template.getObjectTemplate(e, t, n, o).createInstance(this, t, n);
                return this._objects.setByPointer((t => t[e]), i),
                i
            }
            getObject(e) {
            ...
            getSequence() {
                if (!this._sequence) {
                    const e = se(( () => {
                        const e = ge(this.project.pointers.historic.sheetsById[this.address.sheetId].sequence.length);
                        return wn(e)
                    }
                    ))
                      , t = se(( () => {
                        const e = ge(this.project.pointers.historic.sheetsById[this.address.sheetId].sequence.subUnitsPerUnit);
                        return bn(e)
                    }
                    ));
        ...
        const wn = e => "number" == typeof e && isFinite(e) && e > 0 ? e : 10
          , bn = e => "number" == typeof e && (0,
        yn.A)(e) && e >= 1 && e <= 1e3 ? e : 30;
        class _n {
            constructor(e, t) {
                this.project = e,
        ...
        function Pn(e) {
            var t, n;
            const o = (null === (t = null == e ? void 0 : e.logging) || void 0 === t ? void 0 : t.internal) ? null !== (n = e.logging.min) && void 0 !== n ? n : Xe.WARN : 1 / 0
              , i = o <= Xe.DEBUG
              , r = o <= Xe.ERROR
              , s = tt(void 0, {
                _debug: i ? console.debug.bind(console, "_coreLogger(TheatreInternalLogger) debug") : En,
                _error: r ? console.error.bind(console, "_coreLogger(TheatreInternalLogger) error") : En
            });
            if (e) {
                const {logger: t, logging: n} = e;
                t && s.configureLogger(t),
                n ? s.configureLogging(n) : s.configureLogging({
                    dev: !1
                })
            }
        ...
        class On {
            constructor(e, t={}, n) {
                ...
                const r = new fe({
                    historic: null !== (o = t.state) && void 0 !== o ? o : {
                        sheetsById: {},
            ...
            get isAttachedToStudio() {
                return console.error("Studio has been removed! This function shouldn't be called anymore"),
                !1
            }
            get ready() {
            ...
            getOrCreateSheet(e, t="default") {
                ...
                return n || (n = new _n(this,e),
                this._sheetTemplates.reduce((t => Object.assign(Object.assign({}, t), {
                    [e]: n
                })))),
                n.getInstance(t)
            }
        ...
        class Tn {
            ...
            setState(e) {
                _e(this).diskStateAtom.setByPointer(_e(this).diskStateAtom.pointer.historic.sheetsById, e)
            }
        }
        n(8792);
        const Mn = (e, t) => {
            ( (e, t) => {
                if (Array.isArray(t) || null == t || t.definitionVersion !== Sn.currentProjectStateDefinitionVersion)
                    throw new vt(`Error validating conf.state in Theatre.getProject(${JSON.stringify(e)}, conf). The state seems to be formatted in a way that is unreadable to Theatre.js. Read more at https://www.theatrejs.com/docs/latest/manual/projects#state`)
            }
            )(e, t)
        }
        ;
        ...
        !function() {
            if ("undefined" == typeof window && !0 !== n.g.__THEATREJS__FORCE_CONNECT_CORE_AND_STUDIO)
                return;
            const e = "undefined" != typeof window ? window : n.g
              , t = e[Et];
            if (void 0 !== t) {
                if ("object" == typeof t && t && "string" == typeof t.version)
                    throw new Error("It seems that the module '@theatre-local/core' is loaded more than once. This could have two possible causes:\n1. You might have two separate versions of Theatre.js in node_modules.\n2. Or this might be a bundling misconfiguration, in case you're using a bundler like Webpack/ESBuild/Rollup.\n\nNote that it **is okay** to import '@theatre-local/core' multiple times. But those imports should point to the same module.");
                console.warn(`The variable window.${Et} seems to be already set by a module other than @theatre-local/core.`)
            }
            const o = new xn;
            e[Et] = o
        }();
        ...
        const Cn = 10
          , In = ["color", "emissive", "specular", "specularColor", "attenuationColor", "sheenColor"]
          , kn = -911231231231232
          , Dn = {
            r: 0,
            g: 0,
            b: 0,
            a: 123456789 * Number.EPSILON
        };
        function jn(e, t) {
            let n = !0;
            const o = function(e, t={}) {
                ...
                return t.state ? (Mn(e, t.state),
                o._debug("deep validated config.state on disk")) : o._debug("no config.state"),
                new Tn(e,t)
            }(e, {
                state: t
            })
                ...
                getAnimation: function(e) {
                    ...
                    return {
                        ...
                        animateObject3D: function(e) {
                            ...
                            const o = ( () => {
                                ...
                                Rn.T4)(e)) {
                                    ...
                                    return (0,
                                    Rn.$s)(e) ? Object.assign(Object.assign({}, t), {
                                        distance: tn(kn),
                                        decay: tn(kn)
                                    }) : (0,
                                    Rn.pr)(e) ? Object.assign(Object.assign({}, t), {
                                        distance: tn(kn),
                                        angle: tn(kn),
                                        penumbra: tn(kn),
                                        decay: tn(kn)
                            ...
                            const s = t.object(An(e), Object.assign({
                                position: en({
                                    x: tn(kn),
                                    y: tn(kn),
                                    z: tn(kn)
                                ...
                                r(e.scale, t.scale),
                                o && Object.entries(o).forEach(( ([n,o]) => {
                                    const i = t[n];
                                    if ("rgba" === o.type) {
                                        if (i.a === Dn.a)
                                            return;
                        ...
                        animateMaterial: function(e) {
                            ...
                            const a = t.object(An(e), s, {
                                reconfigure: !0
                            }).onValuesChange((t => {
                                if (n)
                                    for (const e in t)
                                        In.includes(e) ? i(e) : o(e);
                                function o(n, o) {
                                    t[n] !== kn && void 0 !== e[n] && (e[n] = o || t[n],
                                    "attenuationDistance" === n && 0 === e[n] && (e[n] = 1 / 0))
                                }
                                function i(e) {
                                    t[e].a !== Dn.a && o(e, new T.Q1f(String(Wt(t[e])).slice(0, -2)))
                                }
                            }
                            ));
                            i.set(e.uuid, a)
        ...
        const Un = Math.pow
          ...
          , Kn = {
            ...
            easeInOutQuad: function(e) {
                return e < .5 ? 2 * e * e : 1 - Un(-2 * e + 2, 2) / 2
            },
            ...
            easeInOutCubic: function(e) {
                return e < .5 ? 4 * e * e * e : 1 - Un(-2 * e + 2, 3) / 2
            },
            ...
            easeInOutQuart: function(e) {
                return e < .5 ? 8 * e * e * e * e : 1 - Un(-2 * e + 2, 4) / 2
            },
            ...
            easeInOutQuint: function(e) {
                return e < .5 ? 16 * e * e * e * e * e : 1 - Un(-2 * e + 2, 5) / 2
            },
            ...
            easeInOutExpo: function(e) {
                return 0 === e ? 0 : 1 === e ? 1 : e < .5 ? Un(2, 20 * e - 10) / 2 : (2 - Un(2, -20 * e + 10)) / 2
            },
            ...
            easeInOutCirc: function(e) {
                return e < .5 ? (1 - Vn(1 - Un(2 * e, 2))) / 2 : (Vn(1 - Un(-2 * e + 2, 2)) + 1) / 2
            },
            ...
            easeInOutBack: function(e) {
                return e < .5 ? Un(2 * e, 2) * (7.189819 * e - Gn) / 2 : (Un(2 * e - 2, 2) * ((Gn + 1) * (2 * e - 2) + Gn) + 2) / 2
            },
            easeInElastic: function(e) {
                return 0 === e ? 0 : 1 === e ? 1 : -Un(2, 10 * e - 10) * Hn((10 * e - 10.75) * Xn)
            },
            easeOutElastic: function(e) {
                return 0 === e ? 0 : 1 === e ? 1 : Un(2, -10 * e) * Hn((10 * e - .75) * Xn) + 1
            },
            easeInOutElastic: function(e) {
                return 0 === e ? 0 : 1 === e ? 1 : e < .5 ? -Un(2, 20 * e - 10) * Hn((20 * e - 11.125) * Jn) / 2 : Un(2, -20 * e + 10) * Hn((20 * e - 11.125) * Jn) / 2 + 1
            },
            ...
            easeInOutBounce: function(e) {
                return e < .5 ? (1 - Yn(1 - 2 * e)) / 2 : (1 + Yn(2 * e - 1)) / 2
            }
        };
        var Zn = n(3631);
        const Qn = new class {
            constructor() {
                ...
                this.overrideLenisSetScrollFunction = e => {
                    e.setScroll = t => {
                        const n = e.velocity
                          , o = e.rootElement
                          , i = n > 0 ? Math.ceil(t) : n < 0 ? Math.floor(t) : Math.round(t);
                        e.isHorizontal ? o.scrollLeft = Math.round(i) : o.scrollTop = Math.round(i)
                    }
                }
                ,
                this.prepareLenisConfig = e => {
                    ...
                    const o = (0,
                    Zn.eB)((null == e ? void 0 : e.duration) / 1e3, 3);
                    o >= 0 && (t.duration = o);
                    const i = (0,
                    Zn.eB)(+e.speed / 100, 2);
                    i > 0 && (t.wheelMultiplier = i,
                    t.touchMultiplier = i),
                ...
                this.reinitialize = e => {
                    ...
                    const o = this.getDeviceSize()
                      , i = null === (n = null === (t = null == e ? void 0 : e.devices) || void 0 === t ? void 0 : t[o]) || void 0 === n ? void 0 : n.scrollSettings;
                    window.scrollTo(0, 0),
                    (null == i ? void 0 : i.type) === p.J.Smooth ? (this.type = p.J.Smooth,
                    this.prepareLenisConfig(i),
                    this.lenis = new Fn.A(this.lenisConfig),
                    this.overrideLenisSetScrollFunction(this.lenis),
                    this.lenis.on("scroll", this.onScroll),
                    this.prepareLenisRaf()) : (this.type = p.J.Native,
                ...
                this.getDeviceSize = () => {
                    ...
                    return e < f.mq ? p.SN.Mobile : e < f.g4 ? p.SN.Tablet : p.SN.Desktop
                }
                ,
        ...
        function no(e, t, n) {
            return eo(this, void 0, void 0, (function*() {
                ...
                o.appendChild(i);
                const r = (0,
                Nn.Vy)(i, e.autoResolutionSettings);
                to.builder = r;
                const {pwObjects: s, pwMaterials: a, parents: l, children: u, effects: d, pwObjectsUsingPwMaterial: f, sharedMaterials: p} = e
                ...
                return r.listenTo(Nn.bd.SceneReady, ( () => {
                    null == m || m(void 0)
                }
                )),
        ...
        function oo(e, t) {
            return eo(this, void 0, void 0, (function*() {
                ...
                function d() {
                    const {height: e, scrollHeight: t, scrolled: n} = Qn.getScrollParameters();
                    if ("percentage" === c) {
                        return function(e, t, n, o) {
                            const i = t + n
                              , r = o.filter((e => e.position > t)).sort(( (e, t) => e.position - t.position));
                            let s, a;
                            for (const e of r) {
                                if (!(e.position <= i)) {
                                    s = e;
                            ...
                            return {
                                ...
                                percentage: (null === (n = null === (t = to.anchors) || void 0 === t ? void 0 : t[e.id]) || void 0 === n ? void 0 : n.percentage) || 0
                            }
                        }
                        )))
                    }
                    return "dynamicViewPort" === c ? n / e * 100 / l : (console.error(`Animation unit type: <${c}> not supported.`),
                    0)
                }
                const h = () => {
                    const e = d();
        ...
        function vo(e) {
            ...
            for (const e of t)
                yo[e.interaction.triggerType](e)
        }
        const wo = {};
        function bo() {
            if (wo.scrollSections)
                return wo.scrollSections;
        ...
        function Eo(e) {
            ...
            return n => {
                ...
                lo(n);
                const o = e.url;
                n.ctrlKey || n.metaKey || e.newTab || Ln.kr ? t.open(o, "_blank") : n.shiftKey ? t.open(o) : t.location.href = o
            }
        }
        function Po(e) {
            const t = window;
            return n => {
                ...
                if (e.newTab && !o) {
                    const n = window.location.href
                      , o = (0,
                    h.sh)(n, e.pagePath, e.sectionHash);
                    return void t.open(o, "_blank")
                }
                if (vr() !== e.pagePath)
                    return void Or(e.pagePath, e.sectionHash);
        ...
        var To, Mo, xo, Ro, Ao, Co, Io, ko, Do = n(6798), jo = n(2407), No = n(3616);
        function Lo(e, t) {
        ...
        const Vo = (e, t) => {
            ...
            case "px":
                return e;
            case "dvh":
                return e / 100 * ((null === (n = window.visualViewport) || void 0 === n ? void 0 : n.height) || window.innerHeight);
            default:
                throw new Error(`Unsupported unit: ${t}`)
            }
        }
        ;
        var Ho, Wo = function(e, t, n, o) {
            return new (n || (n = Promise))((function(i, r) {
                function s(e) {
                    try {
                        c(o.next(e))
        ...
        function Xo(e) {
            ...
            const t = function(e) {
              ...
              , n = "object" == typeof e ? {
                keyframe: Object.assign(Object.assign({}, t.keyframe), e.keyframe),
                transition: Object.assign(Object.assign({}, t.transition), e.transition)
            } : t;
            return {
                keyframe: Go(n.keyframe),
                transition: (o = n.transition,
                o.type === Ro.Spring ? {
                    type: "spring",
                    delay: qo(o.delay),
        ...
        function Yo(e) {
            ...
            const i = function(e) {
                ...
                if (e.startsWith("matrix3d")) {
                    const t = e.match(/matrix3d\(([^)]+)\)/)[1].split(",").map(parseFloat)
        ...
        function Ko(e, t) {
            ...
            case Ao.SectionInView:
                {
                    const e = t === Ho.Exited || i === Ho.Exited ? n.effectB : n.effectA;
                    if (e) {
                        return {
        ...
        function ei(e) {
            return Wo(this, void 0, void 0, (function*() {
                ...
                if (!i)
                    return t.currentState = o,
                    t.animationInProgress = !1,
                    ei(e);
                t.animationInProgress = !0;
                const r = t.isFirstAnimation ? Object.assign(Object.assign({}, i.transition), {
                    velocity: 0
                }) : i.transition;
        ...
        function ni(e) {
            ...
            Qo(t.clickThrough)(o, t.effectA.keyframe, {
                duration: 0
            }),
            (0,
            jo.l)(o, ( () => {
        ...
        function ri(e) {
            const {animation: t, state: n} = e
              , {el: o} = n;
            t.effectA && (o.style.opacity = `${t.effectA.keyframe.opacity}`,
            Qo(t.clickThrough)(o, t.effectA.keyframe, {
                duration: 0
            }));
            const i = (0,
            jo.l)(o, (o => {
                ...
                return t.effectA && !t.replay && i(),
                n.desiredState = Ho.Entered,
                ti(e),
                o => {
                    t.replay || i();
                    const s = ii(o.boundingClientRect) <= r;
                    n.desiredState = s ? Ho.Exited : Ho.Initial,
                    ti(e)
                }
            }
            ), {
        ...
        function li(e, t) {
            ...
            e.type !== Ao.ElementInView && e.type !== Ao.SectionInView || e.effectB && (e.effectB.keyframe.opacity *= t.defaultKeyframe.opacity)
        }
        function ui(e) {
            const t = function(e) {
                const t = new Map;
            ...
            No.I)((e => {
                ...
                t > n ? zo.lastScrollDirection = Co.Down : t < n && (zo.lastScrollDirection = Co.Up),
                zo.lastScrollDirection && zo.lastScrollDirection !== r && function(e, t) {
                    const n = [];
                    for (const [o,i] of t) {
                        const {animation: t, state: r} = i
                          , s = t.direction === e
                          , a = r.desiredState === Ho.Initial;
                        s && a ? (r.desiredState = Ho.Entered,
                        ti(i),
                        t.replay || n.push(o)) : s || a || (r.desiredState = Ho.Initial,
                        ti(i))
                    }
                    for (const e of n)
                        t.delete(e)
        ...
        function bi(e) {
            if (wi(e) !== pi.None)
                return e.iconPlayUrl
        }
        function _i(e) {
            if (wi(e) !== pi.None)
                return e.iconPauseUrl
        }
        function Si(e, t) {
            const n = document.createElement("div");
            n.style.width = "100%",
            n.style.height = "100%";
            return wi(t) === pi.Custom ? (n.style.backgroundImage = `url("${encodeURI(e)}")`,
            n.style.backgroundSize = "contain",
            n.style.backgroundPosition = "center",
            n.style.backgroundRepeat = "no-repeat") : (n.style.backgroundColor = function(e) {
        ...
        function Oi(e, t) {
            var n;
            const o = (null === (n = null == e ? void 0 : e.audio) || void 0 === n ? void 0 : n[t]) || {}
              , i = function(e) {
                return {
                    sourceType: e,
                    src: "",
        ...
        function Ti(e, t) {
            var n;
            const o = (null === (n = null == e ? void 0 : e.audioStyle) || void 0 === n ? void 0 : n[t]) || {}
              , i = {
                playCursor: yi,
                playIconType: gi,
                playIconColor: vi,
        ...
        function Mi(e) {
            ...
            e.iconDivEl = void 0;
            const o = !!(null === (n = e.howl) || void 0 === n ? void 0 : n.playing());
            o && (e.playedOnce = !0);
        ...
        function Ii(e) {
            return Ei(this, void 0, void 0, (function*() {
                Pi.loadPromise || (Pi.loadPromise = Ci(e)),
                yield Pi.loadPromise
            }
            ))
        }
        function ki(e) {
        ...
        function Di(e) {
            ...
            !e.playedOnce) {
                if (e.attrs.progress > 0) {
                    const o = ((null === (t = e.howl) || void 0 === t ? void 0 : t.duration()) || 0) * e.attrs.progress;
        ...
        function ji(e) {
            ...
            e.attrs.src) {
                const t = new hi.Howl({
                    ...
                    onfade: () => {
                        var t, n, o;
                        const i = (null === (t = e.howl) || void 0 === t ? void 0 : t.volume()) || 0
                          , r = !!(null === (n = e.howl) || void 0 === n ? void 0 : n.playing());
                        i <= 0 && r && e.wasFadedOut && (e.wasPausedByFadeOut = !0,
            ...
            const t = function(e) {
                return t => {
                    ...
                    co(t),
                    lo(t),
                    (!e.attrs.autoplay || e.playedOnce) && ((null === (n = e.howl) || void 0 === n ? void 0 : n.playing()) ? null === (o = e.howl) || void 0 === o || o.pause() : xi(e))
                }
            }(e)
              , {el: n} = e;
            ...
            if (Pi.audioFadeOut !== e)
                ...
                Pi.audioFadeOut)
                    for (const e of Pi.onLeavePauseAudios) {
                        e.wasFadedOut = !1,
                        e.wasPausedByFadeOut = !1;
                        const t = e.howl;
                        if (!t)
                            continue;
                        t.playing() && (e.wasFadedOut = !0,
                    ...
                    for (const e of Pi.onLeavePauseAudios) {
                        ...
                        e.wasFadedOut = !1;
                        const t = e.howl;
                        t && (t.fade(t.volume(), e.attrs.volume, 1e3),
        ...
        function Bi(e, t) {
            ...
            if (!o.howl)
                return;
            if (!o.isUnlocked && t !== ao.MouseClick)
                return;
            if (e.event !== ro.Pause && e.event !== ro.Stop || (o.attrs.autoplay = !1),
            o.attrs.autoplay && !o.playedOnce)
                return;
            const i = !!o.howl.playing()
              , r = function(e, t) {
                return e === ro.TogglePlayPause ? t ? ro.Pause : ro.Play : e === ro.TogglePlayStop ? t ? ro.Stop : ro.Play : e
            }(e.event, i);
            i ? r === ro.Pause ? o.howl.pause() : r === ro.Stop && o.howl.stop() : r === ro.Play ? o.howl.play() : r === ro.Stop && o.howl.stop()
        }
        function Fi() {
            const {loadingDone: e, audios: t} = Pi;
            if (!e || !t)
                throw new Error("UIAudioModule needs to be loaded before it can be initialized.");
            Array.from(t.values()).forEach((e => {
                ji(e)
            }
            ));
            ...
            const i = () => {
                return e = !document.hidden,
                Pi.documentVisibility = e,
                void Ni();
                var e
            }
            ;
        ...
        function zi(e) {
            ...
            return c.x && a.push(`translateX(${c.x}px)`),
        ...
        function Ji(e, t) {
            return 0 !== function(e, t) {
                ...
                for (let o = 0; o < t.length; o++) {
                    const i = t[o]
                      , r = t[(o + 1) % t.length];
                    i.y <= e.y ? r.y > e.y && Xi(i, r, e) > 0 && n++ : r.y <= e.y && Xi(i, r, e) < 0 && n--
                }
                return n
            }(e, t)
        }
        var Yi, Ki, Zi = function(e, t, n, o) {
            return new (n || (n = Promise))((function(i, r) {
                function s(e) {
                    try {
                        c(o.next(e))
            ...
            Wi.A)((o => {
                const r = function(e) {
                    ...
                    for (let t = 1; t < e.length; t++)
                        (e[t].x < e[n].x || e[t].x === e[n].x && e[t].y < e[n].y) && (n = t);
                    let o, i = n;
                    do {
                        t.push(e[i]),
                        o = (i + 1) % e.length;
                        for (let t = 0; t < e.length; t++) {
                            ...
                            (2 == n || 0 == n && qi(e[i], e[t]) > qi(e[i], e[o])) && (o = t)
                        }
                        i = o
                    } while (i != n);
                    return t
                }([...nr(t.getBoundingClientRect()), ...nr(n.getBoundingClientRect())]);
                if (!r)
                    return;
                Ji({
                    x: o.clientX,
                    y: o.clientY
                }, r) || (e.desiredState = Ki.Closed,
                cr(e),
                i())
            }
            ), 200, {
        ...
        function sr(e) {
            var t, n;
            null === (t = e.disposeMouseMoveListenerCb) || void 0 === t || t.call(e),
            null === (n = e.disposeClickAwayListenerCb) || void 0 === n || n.call(e)
        }
        function ar(e) {
            return Zi(this, void 0, void 0, (function*() {
                e.isAnimating = !0;
                const {el: t, desiredState: n} = e;
                n === Ki.Open ? (t.style.display = "block",
                e.type === Yi.Relative && function(e) {
                    var t, n;
                    e.overlay.dismissType === Hi.Auto && (null === (t = e.disposeMouseMoveListenerCb) || void 0 === t || t.call(e),
                    e.disposeMouseMoveListenerCb = or(e)),
                    [Hi.Auto, Hi.Click].includes(e.overlay.dismissType) && (null === (n = e.disposeClickAwayListenerCb) || void 0 === n || n.call(e),
                ...
                e.currentState = Ki.Open) : (e.type === Yi.Relative && sr(e),
                yield(0,
                Do.i)(t, {
                    opacity: 0
                }, {
        ...
        function cr(e) {
            e.isAnimating || e.isDisposed || e.desiredState !== e.currentState && ar(e)
        }
        function lr(e) {
        ...
        function pr(e) {
            ...
            Object.entries(i).map(( ([e,t]) => {
                ...
                (null == f ? void 0 : f.effectA) && "none" !== p && (o.style.opacity = `${f.effectA.keyframe.opacity}`,
                Qo(!1)(o, f.effectA.keyframe, {
                    duration: 0
                }));
                let h = 0;
                d === Io.Center && (h = r / 2),
                ...
                o.forEach((e => {
                    e && function(e, t, n) {
                        ...
                        fr(this, void 0, void 0, (function*() {
                            if (!e)
                                return;
                            const {element: i, offsetTop: r, height: s, animationEffect: a, durationInPx: c, offsetInPx: l, initialDisplay: u} = e
                              , d = r + l
                              , f = d + (c || s)
                              , p = "fixed" === window.getComputedStyle(i).getPropertyValue("position")
                              , h = n >= d && n < f
                              , m = n < d;
                            if (h && !p)
                                i.style.position = "fixed",
                                i.style.display = u,
                                a && (t.desiredState = Ho.Entered,
                                ti({
                                    animation: a,
                                    state: t
                                }));
        ...
        function _r() {
            return mr(this, void 0, void 0, (function*() {
                try {
                    ...
                    if (!o)
                        throw new Error("Error page wrap not found.");
                    (0,
                    Bn.b)(),
        ...
        const Sr = () => window.innerWidth < f.mq ? p.SN.Mobile : window.innerWidth < f.g4 ? p.SN.Tablet : p.SN.Desktop;
        function Er(e) {
            return mr(this, void 0, void 0, (function*() {
                const t = yield S(e);
        ...
        function Or(e, t, n) {
            ...
            function() {
                return mr(this, void 0, void 0, (function*() {
                    ...
                    if (!a)
                        throw new Error("Failed loading a new page: page body wrap not found.");
                    const c = t.getElementById(l);
                    if (!c)
                        throw new Error("Failed loading a new page: page loading wrap not found.");
                    if (document.body.replaceChildren(a, c),
        ...
        function Tr() {
            if (!yr.nextNavigateTo)
                return;
            const {path: e, sectionHash: t} = yr.nextNavigateTo;
            yr.nextNavigateTo = void 0,
            Or(e, t)
        }
        function Mr() {
            const e = Ln.xB
              , t = (0,
            h.f9)(window.location.hash, "#")
            ...
            window.addEventListener("popstate", ( () => {
                Or(window.location.pathname, (0,
                h.f9)(window.location.hash, "#"), !0)
            }
            ))
        }
        function xr(e, t) {
    ...
    6615: (e, t, n) => {
        ...
        ["opacity", "color", "aoMapIntensity"])
          , c = (new Set(["intensity", "color", "distance", "decay", "angle", "penumbra"]),
        {
            [i.J8.Unlit]: [...a, "reflectivity"],
            [i.J8.Lit]: [...a, "emissive", "roughness", "metalness", "displacementScale", "emissiveIntensity"],
            [i.J8.Physical]: [...a, "emissive", "roughness", "metalness", "displacementScale", "emissiveIntensity", "attenuationDistance", "attenuationColor", "clearcoat", "clearcoatRoughness", "dispersion", "thickness", "transmission", "ior", "iridescence", "iridescenceIOR", "reflectivity", "specularIntensity", "specularColor", "sheen", "sheenColor", "sheenRoughness"],
            [i.J8.Phong]: [...a, "emissive", "reflectivity", "displacementScale", "bumpScale", "emissive", "refractionRatio", "shininess", "specular", "emissiveIntensity"]
        })
          , l = (i.J8.Unlit,
    ...
    592: (e, t, n) => {
        ...
        function c(e) {
            ...
            function n(e, n) {
                const o = t[e]
                  , i = new Proxy(o,s(["x", "y", "z", "_x", "_y", "_z"], (e => {
                    t.dispatchEvent({
                        type: n,
                        target: t,
                        property: e
            ...
            if (n("position", i.UpdatePosition),
            ...
            a.T4)(e)) {
                ...
                return (0,
                a.$s)(e) && n.push("distance", "decay"),
                (0,
                a.pr)(e) && n.push("distance", "angle", "penumbra", "decay"),
                new Proxy(t,s(n, (e => t.dispatchEvent({
                    type: i.UpdateLight,
                    target: t,
                    property: e
                }))))
        ...
        var l = n(4151)
          ...
          , d = n(6615);
        function f(e) {
            Array.isArray(e) ? e.forEach((e => f(e))) : (Object.keys(e).forEach((t => {
                const n = e[t];
                !!n && "object" == typeof n && "dispose"in n && "function" == typeof n.dispose && n.dispose()
            }
            )),
            e.dispose())
        }
        ...
        function m(e, t, n) {
            ...
            (0,
            a.HM)(t) && (n && (0,
            a.HM)(n) && n.loop === t.loop || e.source.data.play(),
        ...
        function y(e) {
            const t = new Map;
            return e.traverse((e => {
                (e instanceof u.eaF || e instanceof u.I46 || e instanceof u.ZLX) && (Array.isArray(e.material) ? e.material.forEach((e => {
                    t.set(e.uuid, e)
                }
        ...
        class w {
            constructor(e, t) {
                ...
                this.loaded = !1,
                this.assetUrl = o,
                this.assetType = n === l.ap.Environment ? e.environmentAssetType : n,
                this.loader = t
            }
            getData() {
                    ...
                    case l.ap.Gltf:
                        this.data.scenes.forEach((e => {
                            e.traverse((function(e) {
                                e instanceof u.eaF && (e.geometry.dispose(),
                                f(e.material))
                            }
                            ))
                        }
        ...
        const _ = {
          ...
          , S = [l.ap.Environment, l.ap.Texture, l.ap.HDRTexture, l.ap.EXRTexture, l.ap.Gltf, l.ap.Obj, l.ap.FBX, l.ap.VideoTexture];
        class E {
            constructor(e, t) {
                ...
                this.assetInstance = t.getData().then((t => {
                    ...
                    case l.ap.Texture:
                        {
                            const {center: n, offset: o, repeat: i, wrapS: r=l.Ps.Clamp, wrapT: s=l.Ps.Clamp} = e
                              , a = t.clone();
                            return a.center = new u.I9Y(n.x,n.y),
                    ...
                    case l.ap.VideoTexture:
                        {
                            const {center: t, offset: n, repeat: i, wrapS: r=l.Ps.Clamp, wrapT: s=l.Ps.Clamp, loop: a} = e
                            ...
                            c.play();
                            const d = new u.Nv2(c);
                            return d.center = new u.I9Y(t.x,t.y),
            ...
            dispose() {
                this.assetInstance.then((e => {
                    if (e instanceof u.Nv2 && (document.body.removeChild(e.source.data),
                    e.dispose()),
        ...
        function P(e, t) {
            ...
            function a() {
                r.size > 0 || s || (s = !0,
                t.dispatchEvent({
                    type: o.ResourcesLoaded
                }))
            }
            function c(t) {
                const o = new w(t,e);
                return n.set(t.assetUrl, o),
                o
            }
            return {
                ...
                deleteResource: function(e) {
                    ...
                    o && (o.usedBy.delete(t.uuid),
                    0 === o.usedBy.size && (n.delete(t.assetUrl),
                    o.dispose()))
                },
                dispose: function() {
                    n.forEach((e => {
        ...
        const N = [D.SMAA, D.SSAO, D.DepthOfField, D.Bloom, D.Vignette, D.ToneMapping, D.BrightnessContrast, D.HueSaturation, D.ColorDepth, D.Noise, D.Pixelation];
        const L = function() {
            const e = new Map;
        ...
        function J(e, t) {
            ...
            return {
                updateEffect: function(o) {
                    ...
                    if (!s)
                        throw new Error("Effect that you are trying to update doesn't exist!");
                    B(o) && function(e, t) {
                        const {blendFunction: n, filter: o, intensity: i, luminanceSmoothing: r, luminanceThreshold: s, opacity: a, radius: c} = t;
                    ...
                    F(o) && function(e, t) {
                        const {blendFunction: n, technique: o, offset: i, opacity: r, darkness: s} = t;
                        e.darkness = s,
                        e.offset = i,
                        e.technique = o,
                        e.blendMode.blendFunction = n,
                    ...
                    W(o) && function(e, t) {
                        const {bokehScale: n, focusRange: o, focusDistance: i, resolutionScale: r, blendFunction: s, opacity: a} = t;
                        e.bokehScale = n,
                    ...
                    z(o) && function(e, t) {
                        const {blendFunction: n, opacity: o, hue: i, saturation: r} = t;
                        e.hue = i,
                        e.saturation = r,
                        e.blendMode.blendFunction = n,
                        e.blendMode.setOpacity(o)
                    ...
                    G(o) && n(s, o),
                    q(o) && function(e, t) {
                        const {blendFunction: n, opacity: o, contrast: i, brightness: r} = t;
                        e.contrast = i,
                        e.brightness = r,
                        e.blendMode.blendFunction = n,
                        e.blendMode.setOpacity(o)
                    ...
                    G(o) && n(s, o),
                    V(o) && function(e, t) {
                        const {edgeContrastFactor: n, edgeMode: o, edgeThreshold: i, predicationMode: r, predicationScale: s, predicationStrength: a, predicationThreshold: c, preset: l} = t;
                        e.applyPreset(l);
                    ...
                    H(o) && function(e, t) {
                        var n;
                        const {bias: o, blendFunction: i, depthAwareUpsampling: r, distanceFalloff: s, distanceThreshold: a, intensity: c, fade: l, luminanceInfluence: d, minRadiusScale: f, opacity: p, radius: h, proximityFalloff: m, proximityThreshold: g, resolutionScale: y, rings: v, samples: w, color: b} = t;
                        e.radius = h,
                        ...
                        _.minRadiusScale = f;
                        const S = (null === (n = _.uniforms.cameraFar) || void 0 === n ? void 0 : n.value) || 2e3;
                    ...
                    X(o) && function(e, n) {
                        const {adaptationRate: o, averageLuminance: i, exposure: r, middleGrey: s, minLuminance: a, mode: c, whitePoint: l, resolution: u, blendFunction: d, opacity: f} = n;
                        e.resolution = u,
                        e.mode = Number(c),
                        e.adaptationRate = o,
                        e.uniforms.get("averageLuminance") && (e.uniforms.get("averageLuminance").value = i),
                        e.uniforms.get("middleGrey") && (e.uniforms.get("middleGrey").value = s),
                        e.uniforms.get("whitePoint") && (e.uniforms.get("whitePoint").value = l),
            ...
            return {
                ...
                createEffect: function(i) {
                    ...
                    if (null === (r = e.get(s)) || void 0 === r ? void 0 : r.effect)
                        throw Error(`Trying to create an effect that's already added ${s}`);
                    let c;
                    if (B(i) && (c = function(e) {
                        const {filter: t, intensity: n, luminanceSmoothing: o, luminanceThreshold: i, radius: r, blendFunction: s} = e
                          , a = new j.bv({
                        ...
                        return a.luminancePass.enabled = !!t,
                        a
                    }(i)),
                    F(i) && (c = function(e) {
                        const {offset: t, darkness: n, technique: o, blendFunction: i} = e;
                        return new j.K1({
                            offset: t,
                            darkness: n,
                            technique: o,
                    ...
                    W(i) && (c = function(e) {
                        const {bokehScale: t, focusRange: n, focusDistance: o, resolutionScale: i, blendFunction: r} = e;
                    ...
                    H(i) && (c = function(e) {
                        const {bias: t, blendFunction: n, color: o, depthAwareUpsampling: i, distanceFalloff: r, distanceThreshold: s, fade: a, luminanceInfluence: c, intensity: l, minRadiusScale: d, radius: f, resolutionScale: p, rings: h, samples: m} = e;
                    ...
                    X(i) && (c = function(e) {
                        const {mode: n, adaptationRate: o, averageLuminance: i, middleGrey: r, minLuminance: s, resolution: a, whitePoint: c, exposure: l} = e
                          , u = new j.i4({
                            mode: Number(n),
                            adaptationRate: o,
                            averageLuminance: i,
                        ...
                        return t.getRenderer().toneMappingExposure = l,
                        u
                    }(i)),
                    !c)
                ...
                deleteEffect: function(o) {
                    var i;
                    const r = null === (i = e.get(o)) || void 0 === i ? void 0 : i.effect;
                    if (!r)
        ...
        class K extends j.Vu {
            disposeWithoutDisposingEffects() {
                for (const e of Object.keys(this)) {
                    const t = this[e];
                    (t instanceof u.nWS || t instanceof u.imn || t instanceof u.gPd || t instanceof j.oF) && this[e].dispose()
                }
                this.setEffects([])
            }
        }
        ...
        function te(e, t, n, o, i) {
            ...
            f.enabled = !1;
            const p = []
              , h = e => Q.get(e) > Q.get(Z.Effects) ? Q.get(e) + p.length - 1 : Q.get(e)
              , m = (e, t) => {
                c.addPass(e, h(t))
            }
            ;
            ...
            function b() {
                p.forEach((e => {
                    c.removePass(e),
                    e.disposeWithoutDisposingEffects()
                }
                )),
                p.length = 0;
                const [t,i] = [...g.entries()].sort(( (e, t) => e[1].order - t[1].order)).reduce(( (e, t) => (e[ee.includes(t[0]) ? 0 : 1].push(t[1].effect),
                e)), [[], []])
                  , s = t.length > 0;
                if (s && (c.multisampling = 0),
                0 === i.length && 0 === t.length || !e.getContext().getContextAttributes())
                    return;
                const l = [[]];
                if (s && t.forEach((e => l[0].push(e))),
                a && i.length > 0) {
                    let e = !1
                      , t = !1;
                    s && l.push([]);
            ...
            function _(e) {
                r = e,
                $e && (c.passes[h(Z.Helpers)].enabled = r,
                c.passes[h(Z.Copy)].enabled = r),
                p.length > 0 ? (c.passes[h(Z.PWObjects)].renderToScreen = !1,
                c.passes[h(Z.Effects) + p.length - 1].renderToScreen = !r) : c.passes[h(Z.PWObjects)].renderToScreen = !r
            }
            function S() {
                const e = i()
                  , o = n();
                if ((null == e ? void 0 : e.camera) && e.camera !== o) {
                    ...
                    e.camera instanceof u.ubm && (e.camera.aspect = t,
                    e.camera.updateProjectionMatrix()),
                    e.camera instanceof u.qUd && (e.camera.left = -t,
                    e.camera.right = t,
                    e.camera.updateProjectionMatrix())
                }
                if (o) {
                    const e = t.x / t.y;
                    o instanceof u.ubm && (o.aspect = e,
                    o.updateProjectionMatrix()),
                    o instanceof u.qUd && (o.left = -e,
                    o.right = e,
                    o.updateProjectionMatrix())
                }
            }
            return {
                ...
                setUsePostProcessing: function(e) {
                    a = e,
                    a || ee.find((e => g.has(e))) ? b() : (p.forEach((e => {
                        c.removePass(e),
                        e.disposeWithoutDisposingEffects()
                    }
                    )),
                ...
                render: function(o) {
                    const a = i()
                      ...
                      , u = e.domElement;
                    if (!u)
                        throw new Error("Canvas parent element is not found! Cannot update canvas size");
                    var d, f, p;
                    if (d = u.clientWidth,
                    f = u.clientHeight,
                    p = e.getPixelRatio(),
                    d === t.x && f === t.y && s === p || (t.set(d, f),
                    s = p,
                    c.setSize(d, f, !1),
                    S()),
                    a && a.camera !== l) {
        ...
        class se extends u.Qev {
            hasTypeListener(e) {
                ...
                return !!n && !!(null === (t = n[e]) || void 0 === t ? void 0 : t.length)
            }
        }
        function ae(e) {
            let t, n = !1;
            const i = function(e) {
                ...
                return t.debug.checkShaderErrors = d.DS,
              ...
              , r = function(e) {
                ...
                const n = new u.Z58
                  , o = new u.$p8
                  , i = new u.eaF(new u.Gu$(1).scale(1, 1, -1),new u.G_z({
                    transparent: !0,
                    depthTest: !1
                }))
                  , r = new u.eaF(new u.Gu$(1).scale(1, 1, -1),new u.G_z({
                    depthTest: !1
                }));
                return n.add(r),
                n.add(i),
            ...
            const g = new se;
            let y, v;
            const {effects: w, render: b, setMainCamera: _, setMainScene: S, createEffect: E, updateEffect: D, deleteEffect: j, setUsePostProcessing: N, setMultiSampling: L, updateCameraProjectionMatrix: B, setRenderHelpers: F} = te(i, s, K, Y, (function() {
                return y
            }
            ));
            const U = function(e) {
                const t = new u.Tap
                  ...
                  , o = new x.H
                  , i = new k
                  , r = $e || "srcdoc" === window.location.pathname ? "/_next/static/" : ""
                  , s = (new O.Z).setDecoderPath(`${r}/draco/`)
                  , a = (new C.p).setTranscoderPath(`${r}/basis/`);
                a.detectSupport(e);
                const c = (new T.B).setCrossOrigin("anonymous").setDRACOLoader(s).setKTX2Loader(a).setMeshoptDecoder(I.f)
                  , d = new R.L
                  , f = new A.w
                  , p = {
                    [l.ap.Gltf]: c,
                ...
                return {
                    load: function(e, t, n=( () => {}
                        ...
                        const o = p[e];
                        if (!o)
                            throw new Error(`No loader for this asset type ${e}`);
                        return o.load(t, n)
                    },
                    loadAsync: (e, t) => {
                        const n = p[e];
            ...
            function q() {
                if (!p || !h || !i)
                    return void console.error("Trying to render with uninitalized objects", {
                        activeScene: p,
                        activeCamera: h,
                        renderer: i
                    });
            ...
            function X() {
                if (!i)
                    throw Error("Renderer is undefined");
            ...
            const Z = ["SpotLightHelper", "PointLightHelper", "DirectionalLightHelper", "CameraHelper"];
            function Q(e) {
                e.traverse((e => {
                    if (!Z.includes(e.type) && e instanceof u.eaF) {
                        ...
                        ;
                        Array.isArray(t.material) ? t.material.forEach((e => {
                            n(e)
                        }
                        )) : n(t.material)
                    }
            ...
            return {
                        ...
                        n && (v = function(e, t, n) {
                            ...
                            function c(t) {
                                const n = e.getBoundingClientRect()
                                  , o = (0,
                                re.qE)((t.clientX - n.x) / n.width, 0, 1)
                                  , i = (0,
                                re.qE)((t.clientY - n.y) / n.height, 0, 1);
                                r(2 * o - 1),
                                s(2 * -i + 1)
                            }
                            return {
                ...
                hideStatsPanel: function() {
                    ...
                    n = !1,
                    t && (t.end(),
                    null === (e = t.dom.parentElement) || void 0 === e || e.removeChild(t.dom))
                },
                setMultiSampling: L,
        ...
        function fe(e) {
            const {canvas: t, eventDispatcher: n, getActiveCamera: i, getActiveScene: r} = e
              , s = t.parentElement
              , a = new u.tBo;
            a.layers.set(l.X6.Raycast),
            a.firstHitOnly = !0;
            const c = (0,
            ce.A)((function(e) {
                const t = {
            ...
            function f(e) {
                ...
                a.setFromCamera(d, n);
                let u = [];
                if ($e ? (a.layers.set(l.X6.HelpersRaycast),
                u = a.intersectObject(o),
                u.length || (a.layers.set(l.X6.Raycast),
                u = a.intersectObject(o))) : (a.layers.set(l.X6.Raycast),
                u = a.intersectObject(o)),
                !u.length)
                    return {
                        distance: 0,
            ...
            const v = {
                [o.MouseDown]: function(e) {
                    if (4 === (void 0 !== e.buttons ? e.buttons : e.which))
                        return;
                    const t = {
                        type: o.MouseDown,
                        data: f(e),
            ...
            return {
                ...
                getObjectsInScreenView: function(e, t) {
                    ...
                    n instanceof u.qUd && function(n) {
                        const {near: o, far: i, left: r, right: s, top: a, bottom: c, zoom: l} = n
                          , u = (s - r) / (2 * l)
                          , d = (a - c) / (2 * l)
                          , f = (s + r) / 2
                          , p = (a + c) / 2;
                    ...
                    g.clear(),
                    o.traverseVisible((e => {
                        if (!e.userData.isCollider)
                            return;
                        if (!e.layers.isEnabled(l.X6.Raycast))
                            return;
                        const t = e;
                        if (null === t.geometry.boundingBox && t.geometry.computeBoundingBox(),
        ...
        function ve(e) {
            const {resourceManager: t, materials: n, objects: o, getActiveScene: i, environmentGenerator: c} = e;
            function l(e) {
                return n.get(e)
            }
            function p(e) {
                const t = ye[e.type];
                if (!t)
                    throw Error("Material type not supported");
                const o = function(e, t) {
                    const n = e;
                    return new Proxy(e,s(Array.from(d.LX[t]), (e => n.dispatchEvent({
                        type: r.Update,
                        property: e,
                        target: n
                    }))))
            ...
            function h(t, o, r=!1) {
                ...
                const {name: w, side: b, color: _, opacity: S, transparent: E, alphaTest: P, envMap: O, aoMapIntensity: T} = t
                  , M = n.get(t.uuid);
                if (!M)
                    throw Error(`Material with ${t.uuid} does not exist`);
                ...
                M.alphaTest = P;
                const x = [g(t, "map", null == o ? void 0 : o.map), g(t, "alphaMap", null == o ? void 0 : o.alphaMap), g(t, "aoMap", null == o ? void 0 : o.aoMap)];
                if ((null == o ? void 0 : o.envMap) && o.envMap.uuid !== (null == O ? void 0 : O.uuid) && e.resourceManager.deleteResource(o.envMap.uuid),
                O ? me(M, (e.resourceManager.getResource(O.uuid) || e.resourceManager.createResource(O)).assetInstance, (e => {
                    var t;
                    const n = e;
                    if (M.userData.hasEnvMap = !0,
                    (0,
                    a.ZF)(M))
                        M.envMap = n.reflection;
                    else if ((0,
                    a.N7)(M))
                        M.envMap = M.userData.useRefraction ? n.refraction : n.reflection;
                    else {
                        const {intensity: e, rotation: o, opacity: i, blurriness: r} = O;
                        null === (t = M.envMap) || void 0 === t || t.dispose();
                        const s = c.generateEnvironment(n.reflection, o, "white", i, e, r);
                        M.envMap = s
                    }
                }
                ...
                (0,
                a.Pd)(t)) {
                    if (!(M instanceof u.V9B))
                        throw Error("Material type mismatch");
                    if (r || (M.reflectivity = t.reflectivity),
                    x.push(g(t, "specularMap", null == o ? void 0 : o.specularMap)),
                    !O) {
                        const t = null === (f = null === (d = null === (l = i()) || void 0 === l ? void 0 : l.environment) || void 0 === d ? void 0 : d.userData) || void 0 === f ? void 0 : f.originalTextureUuid;
                        t && me(M, null === (p = e.resourceManager.getResource(t)) || void 0 === p ? void 0 : p.assetInstance, (e => {
                ...
                a.K2)(t)) {
                    ...
                    a.uK)(M))
                        throw Error("Material type mismatch");
                    const {flatShading: e, roughness: n, displacementScale: i, emissive: s, emissiveIntensity: c, metalness: l} = t;
                    if (r || (M.metalness = l,
                    M.roughness = n,
                    ...
                    M.emissive.set(s)),
                    M.flatShading = e,
                    x.push(g(t, "metalnessMap", null == o ? void 0 : o.metalnessMap), g(t, "emissiveMap", null == o ? void 0 : o.emissiveMap), g(t, "normalMap", null == o ? void 0 : o.normalMap), g(t, "roughnessMap", null == o ? void 0 : o.roughnessMap), g(t, "displacementMap", null == o ? void 0 : o.displacementMap)),
                    (0,
                    a.K2)(t) && (0,
                    a.uK)(M)) {
                        const {ior: e, reflectivity: n, iridescence: i, iridescenceIOR: s, sheen: a, sheenColor: c, sheenRoughness: l, clearcoat: u, clearcoatRoughness: d, transmission: f, dispersion: p, thickness: h, attenuationColor: m, attenuationDistance: y, specularIntensity: v, specularColor: w} = t;
                        r || (M.ior = e,
                        M.reflectivity = n,
                        M.iridescence = i,
                        M.iridescenceIOR = s,
                        ...
                        x.push(g(t, "iridescenceMap", null == o ? void 0 : o.iridescenceMap))
                    }
                }
                if ((0,
                a.HA)(t)) {
                    if (!(M instanceof u.tXL))
                        throw Error("Material type mismatch");
                    const {flatShading: n, bumpScale: s, displacementScale: a, emissive: c, emissiveIntensity: l, refractionRatio: d, useRefraction: f, shininess: p, reflectivity: w, specular: b} = t;
                    if (r || (M.bumpScale = s,
                    M.reflectivity = w,
                    ...
                    M.flatShading = n,
                    x.push(g(t, "specularMap", null == o ? void 0 : o.specularMap), g(t, "emissiveMap", null == o ? void 0 : o.emissiveMap), g(t, "normalMap", null == o ? void 0 : o.normalMap), g(t, "bumpMap", null == o ? void 0 : o.bumpMap), g(t, "displacementMap", null == o ? void 0 : o.displacementMap)),
                    !O) {
                        const t = null === (y = null === (m = null === (h = i()) || void 0 === h ? void 0 : h.environment) || void 0 === m ? void 0 : m.userData) || void 0 === y ? void 0 : y.originalTextureUuid;
                        t && me(M, null === (v = e.resourceManager.getResource(t)) || void 0 === v ? void 0 : v.assetInstance, (e => {
                            const t = e;
            ...
            const g = (e, i, r) => {
                ...
                const c = e[i]
                  , l = n.get(e.uuid);
                if (!l)
                    throw new Error(`Material with ${e.uuid} does not exist`);
                if (r && r.uuid !== (null == c ? void 0 : c.uuid) && t.deleteResource(r.uuid),
                (0,
                he.A)(c, r))
                    return;
                if (!c)
                    return void (l[i] = null);
                const u = e => {
                    e ? (m(e, c, r),
                    l[i] = e,
                    l.needsUpdate = !0) : l[i] = null
                }
                ;
                if (c) {
                    if (c.assetUrl !== d.j4)
                        return me(l, null === (a = t.getResource(c.uuid) || t.createResource(c)) || void 0 === a ? void 0 : a.assetInstance, (e => {
                            u(e)
                        }
                        ));
                    {
                        const t = null === (s = o.get(e.overrideObjectId)) || void 0 === s ? void 0 : s.userData;
                        if (!t)
                            return;
            ...
            return {
                ...
                deleteMaterial: function(e) {
                    const t = n.get(e);
                    if (!t)
                        throw new Error(`Cannot delete material that does not exist! ${e}`);
                    t.dispose(),
                    n.delete(e)
                },
                replaceMaterial: function(e, t) {
                    ...
                    r.traverse((e => {
                        ((0,
                        a.uW)(e) || (0,
                        a.GZ)(e)) && (Array.isArray(e.material) ? e.material.forEach(( (t, n) => {
        ...
        function be(e) {
            ...
            if ((0,
            a.ME)(e)) {
                const {width: n, height: o, widthSegments: i, heightSegments: r} = e;
                t = new u.bdM(n,o,i,r)
            }
            if ((0,
            a.HP)(e)) {
                const {width: n, height: o, depth: i, widthSegments: r, heightSegments: s, depthSegments: a} = e;
                t = new u.iNn(n,o,i,r,s,a)
            }
            if ((0,
            a.hU)(e)) {
                const {radius: n, widthSegments: o, heightSegments: i, phiStart: r, phiLength: s, thetaStart: a, thetaLength: c} = e;
                t = new u.Gu$(n,o,i,r,s,a,c)
            }
            if ((0,
            a.SR)(e)) {
                const {radiusTop: n, radiusBottom: o, height: i, radialSegments: r, heightSegments: s, openEnded: a, thetaStart: c, thetaLength: l} = e;
                t = new u.Ho_(n,o,i,r,s,a,c,l)
            }
            if ((0,
            a.pU)(e)) {
                const {radius: n, tube: o, radialSegments: i, tubularSegments: r, arc: s} = e;
                t = new u.O3Y(n,o,i,r,s)
            }
            if ((0,
            a.dj)(e)) {
                const {radius: n, height: o, radialSegments: i, heightSegments: r, openEnded: s, thetaStart: a, thetaLength: c} = e;
        ...
        function Ee(e, t) {
            ...
            function o(t, n, o, i) {
                ...
                a.I$)(n)) {
                    ...
                    i && (0,
                    a.I$)(i) && i.map && i.map.uuid !== (null == s ? void 0 : s.uuid) && e.resourceManager.deleteResource(i.map.uuid),
                    s ? me(r, (e.resourceManager.getResource(s.uuid) || e.resourceManager.createResource(s)).assetInstance, (e => {
                        const t = e;
                        m(t, s, null == i ? void 0 : i.map),
                        r.map = t
                    }
                    )) : r.map = null
                }
            ...
            return {
                updateObject: function(r, s, c=!1) {
                    ...
                    if (!d)
                        throw new Error("Objects that you are trying to update doesn't exist!");
                    ...
                    c || i(d, r),
                    (0,
                    a.Jv)(r) && function(n, o, i) {
                        var r;
                        const {uuid: s, object: a, animation: c, castShadow: u, receiveShadow: d} = o;
                        if (i && i.castShadow === u && i.receiveShadow === d || n.traverse((e => {
                            e.castShadow = o.castShadow,
                            e.receiveShadow = o.receiveShadow
                        }
                        )),
                        (0,
                        he.A)(null == i ? void 0 : i.animation, c))
                            return;
                        const {clipName: f} = c;
                        f ? me(n, null === (r = e.getResource(a.uuid)) || void 0 === r ? void 0 : r.assetInstance, (e => {
                            var o;
                            if (a.assetType !== l.ap.Gltf)
                                return;
                            const r = e.animations;
                            (null == i ? void 0 : i.animation.clipName) && i.animation.clipName !== f && t.removeAnimation(i.uuid, i.animation.clipName);
                            const u = t.getAnimation(s, f);
                            if (u)
                                t.updateAnimation(s, c),
                                u.play();
                            else {
                                const e = r.find((e => e.name === f))
                                  , i = null === (o = n.children.find((e => !!e.userData.isGLTF))) || void 0 === o ? void 0 : o.children[0];
                                if (!e || !i)
                                    throw Error(`No animation clip with this name ${f} or root ${n}`);
                                t.createAnimation(i, s, e, c).play()
                            }
                        }
                        )) : (null == i ? void 0 : i.animation.clipName) && t.removeAnimation(i.uuid, i.animation.clipName)
                    }(d, r, s),
                    (0,
                    a.G_)(r) && o(d, r, c, s),
                    (0,
                    a.jA)(r) && function(e, t, n) {
                        const {flowDirectionX: o, flowDirectionY: i, flowSpeed: r, color: s, quality: a, useRefraction: c, waveScale: l, reflectivity: u} = t;
                        n && c !== n.useRefraction && e.setUseRefraction(c),
                        n && a !== n.quality && e.setResolution(t.quality),
                        n && s !== n.color && e.material.uniforms.color.value.set(s),
                    ...
                    (0,
                    a.uQ)(r) && function(t, i, r) {
                        var s;
                        const {background: c, environment: l, ambientLight: d, fog: f, useEnvironmentAsBackground: p, backgroundBlurriness: h, backgroundTransparent: m, multisampling: g} = i;
                        if (t.backgroundBlurriness = h,
                        (null == r ? void 0 : r.environment) && r.environment.uuid !== (null == l ? void 0 : l.uuid) && e.resourceManager.deleteResource(r.environment.uuid),
                        l ? me(t, (e.resourceManager.getResource(l.uuid) || e.resourceManager.createResource(l)).assetInstance, (o => {
                            var i;
                            const r = o
                              , {intensity: s, rotation: u, opacity: d, blurriness: f} = l;
                            null === (i = t.environment) || void 0 === i || i.dispose();
                            const h = n.generateEnvironment(r.reflection, u, "string" == typeof c ? c : "white", d, s, f);
                            t.environment = h,
                            h.userData.originalTextureUuid = l.uuid,
                            p && !m && (t.background = r.reflection),
                            e.materials.forEach((e => {
                                (0,
                                a.ZF)(e) && !e.userData.hasEnvMap && (e.envMap = r.reflection),
                                (0,
                                a.N7)(e) && !e.userData.hasEnvMap && (e.envMap = e.userData.useRefraction ? r.refraction : r.reflection)
                            }
                            ))
                        }
                        )) : (t.environment = null,
                        e.materials.forEach((e => {
                            !(0,
                            a.ZF)(e) && !(0,
                            a.N7)(e) || e.userData.hasEnvMap || (e.envMap = null)
                        }
                        ))),
                        (null == r ? void 0 : r.background) && "string" != typeof r.background && r.background.uuid !== c.uuid && e.resourceManager.deleteResource(r.background.uuid),
                        m || !c)
                            t.background = null;
                        else if (!p || !l)
                            if ("string" == typeof c) {
                                const e = t.background;
                                (null == e ? void 0 : e.isColor) ? e.set(c) : t.background = new u.Q1f(c)
                            } else
                                me(t, null === (s = e.resourceManager.getResource(c.uuid) || e.resourceManager.createResource(c)) || void 0 === s ? void 0 : s.assetInstance, (e => {
                                    t.background = e
                                }
                                ));
                        const y = e.objects.get(d.uuid);
                        y && (y.visible = d.visible,
                        o(y, d, !1)),
                        (null == g ? void 0 : g.enabled) ? e.setMultiSampling(g.samples) : e.setMultiSampling(0),
                        (null == f ? void 0 : f.enabled) ? t.fog = new u.jUj(f.useBackgroundColor ? "string" == typeof i.background ? i.background : "#FFFFFF" : f.color,f.near,f.far) : (null == f ? void 0 : f.enabled) || (t.fog = null)
                    }(d, r, s),
                    (0,
                    a.V0)(r) && function(t, n, o) {
                        var i;
                        const {geometry: r} = n;
                        if ((null == o ? void 0 : o.geometry) && r !== (null == o ? void 0 : o.geometry)) {
                            const e = !!(null === (i = n.raycastConfig) || void 0 === i ? void 0 : i.enabled);
                            t.geometry = be(r),
                            e && t.geometry.computeBoundsTree(_e)
                        }
                        if (n.materialId !== (null == o ? void 0 : o.materialId)) {
                            const o = e.materials.get(n.materialId);
                            if (!o)
                                throw Error(`Material with ${n.materialId} does not exist!`);
                            t.material = o
                        }
                    }(d, r, s),
                    (0,
        ...
        class xe extends u.eaF {
            constructor(e, t) {
                ...
                this.isWater = !0;
                const {flowSpeed: o=.03, textureHeight: i=512, textureWidth: r=512, clipBias: s=0, flowDirection: a=new u.I9Y(1,0), reflectivity: c=.02, scale: l=1, flowMap: d, normalMap0: f, normalMap1: p, useRefraction: h=!1} = t;
                this.flowSpeed = o,
                this.useRefraction = h;
                ...
                this.useRefraction && (this.refractor = new Pe.N(e,{
                    textureWidth: r,
                    textureHeight: i,
                    clipBias: s
                }),
                ...
                void 0 !== d ? (this.material.defines.USE_FLOWMAP = "",
                this.material.uniforms.tFlowMap = new u.nc$(d)) : this.material.uniforms.flowDirection = new u.nc$(a),
                this.useRefraction && (this.material.defines.USE_REFRACTION = "",
                this.material.uniforms.tRefractionMap.value = null === (n = this.refractor) || void 0 === n ? void 0 : n.getRenderTarget().texture),
                ...
                this.onBeforeRender = function(e, t, n, o, i, r) {
                    ...
                    this.useRefraction && (null === (s = this.refractor) || void 0 === s || s.onBeforeRender(e, t, n, o, i, r),
                    null === (a = this.refractor) || void 0 === a || a.matrixWorld.copy(this.matrixWorld)),
                    this.visible = !0
                }
            }
            ...
            setUseRefraction(e) {
                var t, n;
                this.useRefraction !== e && (this.useRefraction ? (this.material.defines.USE_REFRACTION = !1,
                null === (t = this.refractor) || void 0 === t || t.dispose()) : (this.refractor = new Pe.N(this.geometry,{
            ...
            updateFlow() {
                ...
                t.value.x >= Te ? (t.value.x = 0,
                t.value.y = Me) : t.value.y >= Te && (t.value.y = t.value.y - Te)
            }
            setResolution(e) {
                var t;
                this.reflector.getRenderTarget().setSize(e, e),
                null === (t = this.refractor) || void 0 === t || t.getRenderTarget().setSize(e, e)
            }
            dispose() {
                var e, t, n, o, i, r, s;
                this.reflector.dispose(),
                null === (e = this.refractor) || void 0 === e || e.dispose(),
                null === (n = null === (t = this.material.uniforms.tNormalMap0) || void 0 === t ? void 0 : t.value) || void 0 === n || n.dispose(),
                null === (i = null === (o = this.material.uniforms.tNormalMap1) || void 0 === o ? void 0 : o.value) || void 0 === i || i.dispose(),
                this.material.dispose(),
                null === (s = (r = this.geometry).disposeBoundsTree) || void 0 === s || s.call(r),
        ...
        function De(e, t) {
            ...
            function r(e, t) {
                ...
                const o = i.get(e)
                  , r = i.get(t);
                if (!o)
                    throw new Error("Cannot set parent relationship!");
            ...
            return {
                ...
                createObject: function t(s, d) {
                    ...
                    let p = null;
                    if (!s.uuid)
                        throw new Error("Object must have a uuid!");
                    if (i.has(s.uuid))
                    ...
                    (0,
                    a.jA)(s) && (p = function(t) {
                        const {flowDirectionX: n, flowDirectionY: o, flowSpeed: i, color: r, waveScale: s, quality: a} = t
                          , c = new u.bdM(1,1);
                        return new xe(c,{
                    ...
                    a.Jv)(s) && (p = function(t) {
                        ...
                        case l.ap.FBX:
                            {
                                ...
                                return i.assetInstance.then((o => {
                                    ...
                                    e.add(r),
                                    (null === (i = t.raycastConfig) || void 0 === i ? void 0 : i.enabled) && je(e),
                                    r.getObjectsByProperty("isLight", !0).forEach((e => {
                                        e.removeFromParent()
                                    }
                                    )),
                                    n(t)
                        ...
                        default:
                            throw Error(`No imported object of this type ${o.assetType}`)
                        }
                    }(s)),
                    (0,
                    a.uQ)(s) && (p = new u.Z58),
                    ...
                    (null === (f = s.raycastConfig) || void 0 === f ? void 0 : f.enabled) && je(p);
                    const y = c(p);
                    i.set(s.uuid, y),
                    n(s),
                    d && r(s.uuid, d),
                    (0,
                    a.uQ)(s) && t(s.ambientLight, s.uuid),
                ...
                deleteObject: function(e) {
                    ...
                    r.dispose && r.dispose(),
                    r instanceof u.Z58 && (null === (o = r.environment) || void 0 === o || o.dispose()),
        ...
        function je(e) {
            e.traverse((e => {
                if (!(e instanceof u.eaF || e instanceof u.I46))
                    return;
        ...
        function Le(e, t, n, o) {
            ...
            const r = function(e, t) {
                ...
                for (const s of r) {
                    const r = null === (o = null === (n = e.devices[s]) || void 0 === n ? void 0 : n.canvases) || void 0 === o ? void 0 : o[t];
                    r && (i[s] = r.cameraId)
                }
                return i
        ...
        function Be() {
            const e = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
            return e < d.mq ? Ne.SN.Mobile : e < d.g4 ? Ne.SN.Tablet : Ne.SN.Desktop
        }
        function Fe(e, t, n, o, i, r) {
            ...
            const g = {
                desktop: null === (s = o(p[Ne.SN.Desktop]) || o(p[r]) || m) || void 0 === s ? void 0 : s.camera,
                tablet: null === (c = o(p[Ne.SN.Tablet]) || o(p[r]) || m) || void 0 === c ? void 0 : c.camera,
                mobile: null === (u = o(p[Ne.SN.Mobile]) || o(p[r]) || m) || void 0 === u ? void 0 : u.camera
            }
              , y = () => {
                const e = Be();
                if (h === e)
        ...
        function We(e, {iterations: t=15, ms: n=1e3, threshold: o=.75, flipflops: i=1 / 0, bounds: r=(e => e > 100 ? [60, 100] : [40, 60]), minResolutionFactor: s=.2, memoizeResolutionFactor: a=!0}) {
            const c = {
                fps: 0,
                index: 0,
                flipped: 0,
                ...
                subscribe: e => {
                    const t = Symbol();
                    return c.subscriptions.set(t, e.current),
                    () => {
                        c.subscriptions.delete(t)
                    }
                }
            };
            if (e.addOnRenderCallback(l),
            a) {
            ...
            function l() {
                ...
                if (c.fallback)
                    return;
                if (l.length >= t)
                    return void (d.DS && console.error("PerformanceMonitorModule: averages.length >= iterations"));
                a.push(performance.now());
                const p = a[a.length - 1] - a[0];
                if (p < n)
                    return;
                if (c.fps = Math.round(1e3 / (p / a.length)),
                c.frames = [],
                l[c.index++ % t] = c.fps,
                l.length < t)
                    return;
                ...
                Ue.i2)(h, m)
                  , w = (0,
                Ue.i2)(l);
                w > c.refreshrate && (c.refreshrate = function(e) {
                ...
                g.length > t * o && w > v && (c.flipped++,
                function(t) {
                    if (t < 1)
                        throw new Error("fpsDeltaFromTargetNorm should be greater than 1 when onIncline is called");
                    if (f() >= window.devicePixelRatio)
                        return;
                    const n = Math.min(window.devicePixelRatio, e.renderer.getPixelRatio() * t);
                    u(n)
                }(b),
                c.subscriptions.forEach((e => e.onIncline && e.onIncline(c)))),
                y.length > t * o && (c.flipped++,
                function(t) {
                    if (Math.sign(t) < 1)
                        throw new Error("fpsDeltaFromTargetNorm should less than 1 when onDecline is called");
                    if (f() <= s)
                        return;
                ...
                c.flipped > i && !c.fallback && (c.fallback = !0,
                c.subscriptions.forEach((e => e.onFallback && e.onFallback(c))),
                d.DS && console.warn("Auto-resolution system disabled: max flipflops reached")),
                c.averages = []
            }
            function u(t) {
        ...
        function ze(e, t, n=!1) {
            ...
            const i = ae(e)
              ...
              , s = function(e) {
                ...
                function i(e, t) {
                    ...
                    if (!i)
                        return;
                    const a = null === (n = o.get(e)) || void 0 === n ? void 0 : n.get(i);
                    if (!a)
                        throw Error(`Animation with name ${i} and object id ${e} does not exist`);
                    a.setLoop(r ? u.aMy : u.G3T, 1 / 0),
                    a.reset(),
                    a.timeScale = s
                }
                function r(e, t) {
                    var i, r;
                    const s = null === (i = o.get(e)) || void 0 === i ? void 0 : i.get(t);
                    s && (s.enabled = !1,
                    s.stop(),
                    s.reset(),
                ...
                return {
                    ...
                    removeObjectAnimations: function(e) {
                        var t;
                        null === (t = o.get(e)) || void 0 === t || t.forEach(( (t, n) => r(e, n)))
                    },
                    updateAnimation: i,
                    ...
                    dispose: function() {
                        n.stopAllAction(),
                        n.getRoot() && n.uncacheRoot(n.getRoot())
                    }
                }
            }(i)
              , c = ve(i);
            ...
            if (!n && (null == t ? void 0 : t.isReductionEnabled)) {
                const {fpsThresholdAbsolute: e=60, minResolution: n=.1, fpsThresholdMode: o} = t || {}
                  , r = window.location !== window.parent.location
                  , s = o === l.GI.Absolute ? e : 60;
                d = We(i, {
                    memoizeResolutionFactor: !r,
                    minResolutionFactor: .01 * (n || 100),
                    flipflops: 8,
                    threshold: .85,
                    iterations: 5,
                    ms: 1e3,
            ...
            const {start: f, stop: p, eventDispatcher: h, addOnRenderCallback: m, removeOnRenderCallback: g, renderer: y, effects: v, setActiveCamera: w, setActiveScene: b, getActiveCamera: _, getActiveScene: S, setCameraPreview: E, setWireframe: P, setUsePostProcessing: O, createEffect: T, updateEffect: M, deleteEffect: x, getResource: R, resourceManager: A, showStatsPanel: C, hideStatsPanel: I, addAfterRenderCallback: k, attachToDOM: D, setRenderHelpers: j} = i
              , {getMaterial: N, updateMaterial: L, createMaterial: B, deleteMaterial: F, replaceMaterial: U} = c;
            m(( (e, t, n) => s.update(n)));
            const {updateObject: V, createObject: H, getObject: W, getAllObjects: $, deleteObject: z, setParentRelationship: G} = De(i, s)
              , {getObjectIntersectionAtPointer: q, getObjectPositionOnScreen: X, getObjectsInScreenView: J} = r
              , {getAnimation: Y} = s;
            function K(e, t, n) {
                const o = W(e);
            ...
            const Z = (e, t) => (we(e) && !h.hasTypeListener(e) && r.addEventListener(e),
            ...
            return {
                ...
                initializeClient: function(t, n, r) {
                    const {pwObjects: s, pwMaterials: c, parents: u, usePostProcessing: d, effects: f} = t;
                    c.forEach((e => B(e))),
                    s.forEach((e => H(e))),
                    ...
                    Fe(e, t, n, W, i, r),
                    s.forEach((e => {
                        i.getActiveScene() || e.type !== l.lV.Scene || i.setActiveScene(W(e.uuid))
                    }
                    )),
                    s.forEach((e => {
                        (0,
                        a.Jv)(e) && e.materials && R(e.object.uuid).assetInstance.then((t => {
                            var n;
                            e.materials && K(e.uuid, t.materials.map((e => e.uuid)), null === (n = e.materials) || void 0 === n ? void 0 : n.map((e => c.get(e))))
                        }
                        ))
                    }
                    ));
                    let p = !1;
                    (d ? f : [...f.values()].filter((e => ee.includes(e.type)))).forEach((e => {
                        e.enabled && (p = p || e.enabled,
                        T(e))
                    }
                    )),
                    O(p && d),
                    Z(o.ResourcesLoaded, ( () => {
                        ...
                        document.location.search.includes("debug") && C(document.body)
                    }
                    )),
